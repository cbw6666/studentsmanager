...
namespace 学生管理系统
{
    ...
    {
        //数据库连接字符串
        public static string Conn = "Database='db_jiaowu';Data Source='localhost';User Id='root';Password='14005cbw';charset='utf8';pooling=true";
      ...
      //  }
       ...
       // public int optb(string strcommandtext) {
          //  int result = 0;
